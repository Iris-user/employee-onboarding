...
class EmployeeRepositoryTest {
    ...
    void findByDepartmentName_returnsOnlyEmployeesInThatDepartment() {
        ...
        repository.save(new Employee(null, "Alice", "Smith", "alice@example.com", engineering, 27, null, null));
        repository.save(new Employee(null, "Bob", "Jones", "bob@example.com", sales, 30, null, null));
        repository.save(new Employee(null, "Carol", "White", "carol@example.com", engineering, 35, null, null));
    ...
    void findByAge_returnsOnlyEmployeesWithThatAge() {
        ...
        repository.save(new Employee(null, "Alice", "Smith", "alice@example.com", engineering, 30, null, null));
        repository.save(new Employee(null, "Bob", "Jones", "bob@example.com", sales, 40, null, null));
        repository.save(new Employee(null, "Carol", "White", "carol@example.com", engineering, 30, null, null));
